...
- Targeted Foundry VTT 13.351 compatibility.
- Targeted Genesys 0.2.19 compatibility.
- Uses Foundry VTT 13 `renderChatMessageHTML`.
- Reads native Genesys 0.2.19 chat roll structures.
- Added Core Rulebook combat, social, medicine, magic, and general result guidance.
- Added Realms of Terrinoth Alchemy and crafting result guidance.
- Added dynamic weapon Critical Rating context.
